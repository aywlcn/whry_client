...
function GameViewLayer:initView(  )
   ...
   self.ifmenu = true
    ...
    self.lock:setPosition(cc.p(1250,325))
...
--菜单
    self.menu = ccui.Button:create("game_res/show_hide.png")
    ...
    self.menuT = ccui.Button:create("game_res/show_isVisible.png")
...
--获取炮台
  nPos = CannonSprite.getPos(self._scene._dataModel.m_reversal,nPos)
   ...
   --金币类型
    ...
    local seAction = cc.Sequence:create(cc.MoveBy:create(0.5,cc.p(moveX,moveY)), cc.DelayTime:create(0.3))--0.3
