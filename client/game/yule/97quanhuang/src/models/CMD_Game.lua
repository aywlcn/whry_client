...
cmd.SUB_S_TWO_GAME_CONCLUDE			= 104		--免费游戏结束
...
cmd.SUB_S_THREE_RES_SCORE   		= 117       --小游戏获得的分数
cmd.SUB_S_UPDATE_JIANGJINCHI_SCORE  = 118		--更新客户端的奖金池
...
cmd.SHZ_CMD_S_GameStart = 
{
	...
	{k="iNowBloodCount",t="int"},--当前血池作弊率
	{k="bChangeIndex",t="int"}--当前选择的索引
...
cmd.SHZ_THREE_SMALL_OK      = 8     --小游戏发送数据
