...
local GameViewLayer = {}
--GameViewLayer.RES_PATH 				= device.writablePath.."game/yule/caiyuangungun/res/"
GameViewLayer.RES_PATH              = "game/yule/caiyuangungun/res/"
--	游戏一
...
local module_pre = "game.yule.caiyuangungun.src"
				...
				node:runAction(
					cc.Sequence:create(
						cc.CallFunc:create(function (  )
							pItem:beginMove(0.0+i*0.1) --滚动延迟+时间差
							if i == 15 then
...
function Game1ViewLayer:showWinScore(winscore)
    ...
    if self.Node_win then
        ...
        local iconX = yl.WIDTH / 2 - (scoreWidth / 2 + 10)
...
function Game2ViewLayer:ctor(scene)
 ...
 function Game2ViewLayer:onEnter()
     ...
     local res_path = "game/yule/caiyuangungun/res/" 
     local plists = {
