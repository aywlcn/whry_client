...
--序列帧个数
cmd.ACT_DAGU_NUM				= 29			--财神
cmd.ACT_QIZHIWAIT_NUM			= 43			--财神
cmd.ACT_QIZHI_NUM 				= 53			--财神
cmd.ACT_TITLE_NUM				= 10			--财神
...
cmd.SHZ_GAME_SCENE_ONE			= 101		--财神开始
cmd.SHZ_GAME_SCENE_TWO			= 102		--比大小开始
cmd.SHZ_GAME_SCENE_THREE		= 103		--小财神开始
...
cmd.SUB_S_THREE_START				= 105		--小财神开始
cmd.SUB_S_THREE_KAI_JIANG			= 106       --小财神开奖                                                                                                   
cmd.SUB_S_THREE_END					= 107		--小财神结束 
...
cmd.SHZ_CMD_S_GameStart = 
{
	...
	{k="cbBounsGameCount",t="byte"}--小财神次数
}
...
cmd.SHZ_SUB_C_THREE_START 	= 3		--财神开始
