...
function PriRoomCreateLayer:getInviteShareMsg( roomDetailInfo )
    ...
    local friendC = "十三水房间ID:" .. roomDetailInfo.szRoomID .. " 局数:" .. roomDetailInfo.dwPlayTurnCount
    return {title = "十三水约战", content = shareTxt .. " 十三水游戏精彩刺激, 一起来玩吧! ", friendContent = friendC}
end
